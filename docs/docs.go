    ...
    "paths": {
        "/cart": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/main.ProductInBasket"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Информация о товаре для добавления",
                        "name": "item",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/cart/{productId}": {
            "delete": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Ошибка удаления из корзины",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/products/{id}": {
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Ошибка обновления продукта",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/refresh": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "example": "\"\u003cтокен\u003e\"",
                        "description": "JWT токен, который нужно обновить",
                        "name": "Authorization",
                        "in": "header",
                        "required": true
                    }
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "Неавторизованный запрос или некорректный токен",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "500": {
                        "description": "Ошибка при генерации нового токена",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
